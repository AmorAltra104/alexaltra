local particleSpawnTime = 0.25 --seconds in between each particle spawn
local particleKillHeight = -500 -- y value at which particles are killed
local particlePoolCount = 100 --max number of particles, dont make it too high
...
local particleAngle = 0 --particle angle
local particleAngleRange = 180
...
local particleSpawnX = 400
local particleWidthRange = 1000
local particleSpawnY = 1000
