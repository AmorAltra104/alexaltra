...
function onCreate()
	...
	makeLuaSprite('BG1', 'bob-ex/bosip-ex/BG1', -1300, -590);
	...
	makeLuaSprite('BG2', 'bob-ex/bosip-ex/BG2', -1300, -600);
	...
	makeLuaSprite('BG3', 'bob-ex/bosip-ex/BG3', -600, -300);




        makeAnimatedLuaSprite('ex', 'bob-ex/bosip-ex/ex_crowd', -320, -50);
	...
	makeLuaSprite('pp', 'bob-ex/bosip-ex/Cj_car', -1900, 300);
