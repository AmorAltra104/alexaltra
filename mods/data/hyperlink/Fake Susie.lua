...
idle_xml_name = 'blue idle'
left_xml_name = 'blue left'
down_xml_name = 'blue down'
up_xml_name = 'blue up'
right_xml_name = 'blue right'
...
name_of_character_xml = 'skyblue'
name_of_character = 'skyblue'
name_of_notetype = 'Sky Blue Sing Note'
...
function onBeatHit()
	...
	if curBeat % 4 == 0  and doIdle then
		objectPlayAnimation(name_of_character, 'idle');
