...
function onUpdate()
if PuedeEsquivarS == true and keyJustPressed('space') and AhiS == true then
...
if PuedeEsquivarS == true and getPropertyFromClass('flixel.FlxG', 'keys.justPressed.CONTROL') and AtacadoS == 0 and AhiS == true then   
...
if PuedeEsquivarS == true and getPropertyFromClass('flixel.FlxG', 'keys.justPressed.CONTROL') and AtacadoS == 1 and AhiS == true then   
   setProperty('BoyFriendAtt.visible', true);
   setProperty('boyfriend.visible', false);
   luaSpritePlayAnimation('BoyFriendAtt', 'Attack');
   setProperty('BoyFriendAtt.x', 500)
