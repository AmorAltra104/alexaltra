...
-----------------------------------------------------------------------
	...
	--------CODING CREW--------
	--CODER 1
	makeLuaText('CODER1', 'JARONJACKPOT', 1000, 132, -1000)
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'Revilo_', 1000, 132, -1000)
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'Lokeeh', 1000, 132, -1000)
	setTextAlignment('ARTIST2', 'center')
	setTextSize('ARTIST2', 25)
	setObjectCamera('ARTIST2', 'other')
	addLuaText('ARTIST2')

	makeLuaText('ARTIST3', 'TheMineFormer', 1000, 132, -1000)
	...
	--MUSICIAN 1
	makeLuaText('MUSICIAN1', 'NunStop', 1000, 132, -1000)
	...
	--CHARTER 1
	makeLuaText('CHARTER1', 'JARONJACKPOT', 1000, 132, -1000)
