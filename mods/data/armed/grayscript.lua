...
idleoffsets = {'-40', '90'} -- I recommend you have your idle offset at 0
leftoffsets = {'47', '82'}
downoffsets = {'-85', '22'}
upoffsets = {'-23', '131'}
rightoffsets = {'-71', '56'}
...
left_alt_xml_name = 'Left'
down_alt_xml_name = 'Down'
up_alt_xml_name = 'Up'
right_alt_xml_name = 'Right'
...
name_of_character_xml = 'Reginald_Assets'
name_of_character = 'reginald'
name_of_notetype = 'Opponent 2 Sing'
...
function onCreate()
    ...
    addAnimationByPrefix(name_of_character, 'enter', 'Ellie Enter Animation', 24, false);
    addAnimationByPrefix(name_of_character, 'armed', 'Ellie React Arm', 24, false);
