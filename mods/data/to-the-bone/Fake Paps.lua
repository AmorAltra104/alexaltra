...
idle_xml_name = 'Idle instance 1'
left_xml_name = 'left instance 1'
down_xml_name = 'fzt instance 1'
up_xml_name = 'Up instance 1'
right_xml_name = 'Right copy instance 1'
...
name_of_character_xml = 'Papyrus'
name_of_character = 'Papyrus'
name_of_notetype = 'GF Sing'
name_of_notetype2 = 'Dad & GF Sing Note' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
...
function onBeatHit()
	...
	if curBeat % 2 == 1  and doIdle then
		objectPlayAnimation(name_of_character, 'idle');
