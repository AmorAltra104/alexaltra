...
idle_xml_name = 'sky idle'
left_xml_name = 'sky right'
down_xml_name = 'sky down'
up_xml_name = 'sky up'
right_xml_name = 'sky left'
...
name_of_character_xml = 'sky-bone'
name_of_character = 'sky-bone'
name_of_notetype = 'Sky Sing Note'
name_of_notetype2 = 'Sky Sing Note1' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
