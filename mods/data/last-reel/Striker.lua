...
if PuedeEsquivarS == true and getPropertyFromClass('flixel.FlxG', 'keys.justPressed.CONTROL') and CargaS == 4 and AtacadoS == 0 and AhiS == true then   
...
if PuedeEsquivarS == true and getPropertyFromClass('flixel.FlxG', 'keys.justPressed.CONTROL') and CargaS == 4 and AtacadoS == 1 and AhiS == true then   
   setProperty('BoyFriendAtt.visible', true);
   setProperty('boyfriend.visible', false);
   luaSpritePlayAnimation('BoyFriendAtt', 'Attack');
   setProperty('BoyFriendAtt.x', 500)
