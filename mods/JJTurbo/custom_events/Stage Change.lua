...
return {
    ...
    deedee = destroyAll or nil
        ...
        local curStgData = dofile('mods/stages/'..curStg..'.lua')
        if curStgData ~= nil and curStgData.newObjects ~= nil then
            for _, __ in pairs(curStgData.newObjects) do
                ...
                curStgData.Events = {}
                callOnLuas('stageDestroyed', {curStg})
                callOnLuas('stageDiscardEvents', {curStg})
            end
        else
...
local function destroyAll(stage)
    for _, __ in pairs(removeableObjects) do
        ...
        if newStage ~= nil and newStage.newObjects ~= nil then
            ...
            runHaxeCode(
                'game.dad.cameraPosition[0] = '..(newStage.charData.dad.camPos.x)-(getMidpointX('dad')+150)..';\n'..
                'game.dad.cameraPosition[1] = '..(newStage.charData.dad.camPos.y)-(getMidpointY('dad')-100)..';\n'..

                'game.boyfriend.cameraPosition[0] = '..(newStage.charData.boyfriend.camPos.x)-(getMidpointX('boyfriend')-100)..';\n'..
                'game.boyfriend.cameraPosition[1] = '..(newStage.charData.boyfriend.camPos.y)-(getMidpointY('boyfriend')-100)..';\n'..

                'game.gf.cameraPosition[0] = '..newStage.charData.gf.camPos.x..';\n'..
                'game.gf.cameraPosition[1] = '..newStage.charData.gf.camPos.y..';\n'
            )
            ...
            runHaxeCode(
                'game.dad.cameraPosition[0] = '..dir.camera_opponent[1]..';\n'..
                'game.dad.cameraPosition[1] = '..dir.camera_opponent[2]..';\n'..

                'game.boyfriend.cameraPosition[0] = '..dir.camera_boyfriend[1]..';\n'..
                'game.boyfriend.cameraPosition[1] = '..dir.camera_boyfriend[2]..';\n'..

                'game.gf.cameraPosition[0] = '..dir.camera_girlfriend[1]..';\n'..
                'game.gf.cameraPosition[1] = '..dir.camera_girlfriend[2]..';\n'
            )
