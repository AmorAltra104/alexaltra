...
local songPositionBar = true --是否开启血条显示
local judgementCounter = false --是否开启计数板
local displayAcc = true --是否显示acc，miss等
...
function onCreatePost()
    ...
    setTextFont('botPlayState', '1.ttf')
    ...
    if songPositionBar then
        ...
        makeGraphic('songPosBar1', getProperty('songPosBG.width') - 1, getProperty('songPosBG.height') - 2, '000000')
        ...
        makeGraphic('songPosBar2', getProperty('songPosBG.width') - 1, getProperty('songPosBG.height') - 2, '00FFFF')
    ...
    if downscroll then
        ...
        setProperty('botPlayState.y', getProperty('healthBarBG.y') + 70)

        if songPositionBar then
            setProperty('songPosBG.y', screenHeight * 0.9 + 40)
            setProperty('songPosBar1.y', screenHeight * 0.9 + 41.5)
            setProperty('songPosBar2.y', screenHeight * 0.9 + 41.5)
            setProperty('songName.y', screenHeight * 0.9 + 43)
        end
    end
