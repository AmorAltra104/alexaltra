...
-- Settings --
local pref = {
    style ='classicTxt', --main thing of hud, all available styles are listed above
    ...
    songName = false, --display song name
...
function switchStyle() -- style
    ...
    if pref.style == 'classicTxt' then
        ...
        setProperty('rating.x', 650); setProperty('rating.y', downscroll and 120 or 680); setTextSize('rating', 20)
        setProperty('misses.x', 520); setProperty('misses.y', downscroll and 120 or 680); setTextSize('misses', 20)
        setProperty('score.x', 350); setProperty('score.y', downscroll and 120 or 680); setTextSize('score', 20)
    end
...
function timerBruh() -- timer
    if pref.style == 'classicTxt' or 'classicIcons' then
        makeLuaText('timer', '00:00/00:00', 500, 388, downscroll and 640 or 60)
        setObjectCamera('timer', 'hud'); setTextAlignment('timer', 'center'); setTextSize('timer', 30)
    end
    if pref.style == 'modern' then
