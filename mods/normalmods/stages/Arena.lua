function onCreate()
	...
	makeLuaSprite('TheBack', 'back', -600, -300);
	addLuaSprite('TheBack',false);
	setLuaSpriteScrollFactor('TheBack', 0.9, 0.9);
	...
	makeLuaSprite('punchwarn', 'warning punch', 0, 0);
	addLuaSprite('punchwarn',true)
	setObjectCamera('punchwarn', 'camother')
