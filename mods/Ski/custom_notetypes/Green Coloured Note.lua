function onCreatePost()
	for i = 0, getProperty('unspawnNotes.length')-1 do
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Green Coloured Note' then
			...
			setPropertyFromGroup('unspawnNotes', i, 'hitCausesMiss', false)
			   ...
			   if getPropertyFromGroup('unspawnNotes', i, 'mustPress') and getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Green Coloured Note' then
