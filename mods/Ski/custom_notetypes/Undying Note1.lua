...
function onCreatePost()
	...
	if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Undying Note1' then
...
function onUpdatePost(el)
    ...
    if getPropertyFromGroup('notes', a, 'noteType') == 'Undying Note1' then
	if sus then
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == "Undying Note1" then
